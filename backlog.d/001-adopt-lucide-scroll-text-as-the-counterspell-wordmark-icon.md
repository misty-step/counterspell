# Adopt Lucide scroll-text as the counterspell wordmark icon

Priority: P2 · Status: open · Estimate: S

## Goal

Adopt the Lucide `scroll-text` icon as the canonical wordmark/logo for
counterspell — transcript watch — maps sessions to panes, arms model-correction.
...
- [ ] The `scroll-text` Lucide icon is rendered in the repo's primary
...
- Lucide icon: https://lucide.dev/icons/scroll-text
